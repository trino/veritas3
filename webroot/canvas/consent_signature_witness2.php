        ...
        <div class="col-sm-10">
    		...
    		<div class="links" style="margin-top: 5px;">
                ...
                <br />
                <?php if(isset($consent_detail) && $consent_detail->signature_company_witness2){?><strong>Current Signature<br /></strong><img src="<?php echo $this->request->webroot.'canvas/'.$consent_detail->signature_company_witness2;?>" style="max-width: 100%;" /><?php }?>
                <br />
