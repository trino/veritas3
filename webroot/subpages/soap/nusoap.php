...
class soap_transport_http extends nusoap_base {
	...
	var $url = 'https://infosearchsite.com/MEWS/ISBService.svc?wsdl';
	var $uri = 'https://infosearchsite.com/MEWS/ISBService.svc?wsdl';
	var $digest_uri = '';
	var $scheme = '';
	var $host = 'https://infosearchsite.com/MEWS/ISBService.svc?wsdl';
	var $port = '';
	var $path = '';
 		...
 		if (isset($this->incoming_headers['www-authenticate']) && $http_status == 401) {
 			...
 			if (strstr($this->incoming_headers['www-authenticate'], "Digest ")) {
				...
				// should have (at least) qop, realm, nonce
 				if (isset($digestRequest['nonce'])) {
 					$this->setCredentials($this->username, $this->password, 'basic', $digestRequest);
 					$this->tryagain = true;
 					return false;
 				}
 			}
