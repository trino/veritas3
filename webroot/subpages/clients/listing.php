                          ...
                          ?>
                    		...
                    		<tr>
                    			...
                    			<td class="actions">
                                    ...
                                    <?php  if($sidebar->orders_list == '1'){?><a href="<?php echo $this->request->webroot; ?>documents/index/?client_id=<?php echo $clients->id;?>" class="btn btn-success" >View Orders</a><?php }?>
                    			</td>
                    		</tr>
