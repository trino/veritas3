...
<table class="table table-striped table-bordered table-advance table-hover recruiters">
                                                ...
                                                foreach($profiles as $r)
                                                {
                                                    ...
                                                    <td>
                                                        <span><input class="profile_client" type="checkbox" <?php if(in_array($r->id,$profile)){?>checked="checked"<?php }?> value="<?php echo $r->id; ?>"/></span>
...
<table class="table table-striped table-bordered table-advance table-hover contacts">
                                                ...
                                                foreach($contact as $r)
                                                {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <span><input class="contact_client" type="checkbox" <?php if(in_array($r->id,$contacts)){?>checked="checked"<?php }?> value="<?php echo $r->id; ?>"/></span>
                                                        <span> <?php echo $r->username; ?> </span>
                                                    </td>
