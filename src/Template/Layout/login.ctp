...
<link href="<?php echo WEB_ROOT;?>assets/admin/pages/css/login.css" rel="stylesheet" type="text/css"/>
...
<form class="register-form" method="post" action="index.html" novalidate="novalidate" style="display: block;">
    ...
    <div class="form-group col-md-12">
        <input class="form-control placeholder-no-fix" type="text" name="fullname" placeholder="Enter name of your company">
    </div>
    <div class="form-group col-md-6">
        <input class="form-control placeholder-no-fix" type="text" name="" placeholder="Signatory's first name">
    </div>
    <div class="form-group col-md-6">
        <input class="form-control placeholder-no-fix" type="text" name="" placeholder="Signatory's last name">
    </div>
    <div class="form-group col-md-6">
        <input class="form-control placeholder-no-fix" type="text" name="" placeholder="Signatory's phone number">
    </div>
    <div class="form-group col-md-6">
        <input class="form-control placeholder-no-fix" type="text" name="" placeholder="Signatory's email address">
    </div>
    <div class="form-group col-md-12">
        <input class="form-control placeholder-no-fix" type="text" name="" placeholder="Billing Address Street Name and Number">
    </div>
    <div class="form-group col-md-6">
        <input class="form-control placeholder-no-fix" type="text" name="" placeholder="City">
    </div>
    <div class="form-group col-md-6">
        <input class="form-control placeholder-no-fix" type="text" name="" placeholder="Postal Code">
    </div>
    <div class="form-group col-md-6">
        <input class="form-control placeholder-no-fix" type="text" name="" placeholder="Province/State">
    </div>
    <div class="form-group col-md-6">
        <select name="country" class="form-control">
				<option value="">Country</option>
    ...
    <div class="form-group col-md-6">
        <input class="form-control placeholder-no-fix" type="text" name="" placeholder="User's first name">
    </div>
    <div class="form-group col-md-6">
        <input class="form-control placeholder-no-fix" type="text" name="" placeholder="User's last name">
    </div>
    <div class="form-group col-md-6">
        <input class="form-control placeholder-no-fix" type="text" name="" placeholder="User's email">
    </div>
    <div class="form-group col-md-6">
        <input class="form-control placeholder-no-fix" type="text" name="" placeholder="User's phone number">
    </div>
...
<div class="copyright">
    <p><center>
        <a href="mailto:info@afimacglobal.com?subject=Veritas&body=Hello,%0A%0APlease%20contact%20me%20with%20information%20regarding%20Veritas.%0A%0AName%20(first,%20last):%0A%0APhone:%20(%20%20%20%20%20%20)%0A%0AThank%20you,">
        <img src="http://localhost/veritas//img/yespleasecontactme.jpg">
        </a>
    </center></p>
...
<script src="<?php echo WEB_ROOT;?>assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
...
<script src="<?php echo WEB_ROOT;?>assets/admin/pages/scripts/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
