...
<h3 class="page-title">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?php echo $this->request->webroot;?>tasks/calender">Todo</a>
                        <i class="fa fa-angle-right"></i>
					</li>
                    <li>
                        <a href="">Tasks (<?php echo $this->request['pass'][0];?>)</a>
                    </li>
				</ul>
            ...
            <div class="row">
                                    <div class="col-md-12">
											<div class="scroller" style="max-height: 600px;" data-always-visible="0" data-rail-visible="0" data-handle-color="#dae3e7">
                                                ...
                                                ?>
                                                    <BR><a href="<?=$this->request->webroot;?>tasks/add?date=<?= $this->request['pass'][0]; ?>" id="event_add" type="button" class="btn red">Add Task </a>
