...
$pdf->TextField('college_school_name'.$k.$k, 50, 5,array(),array('v'=>$edu->college_school_name, 'dv'=>$edu->college_school_name));
$pdf->Ln(6);

$pdf->Cell(80, 5, 'Address');
$pdf->TextField('address'.$k.$k, 50, 5,array(),array('v'=>$edu->address, 'dv'=>$edu->address));
$pdf->Ln(6);

$pdf->Cell(80, 5, 'Supervisor\'s Name');
$pdf->TextField('supervisior_name'.$k.$k, 50, 5,array(),array('v'=>$edu->supervisior_name, 'dv'=>$edu->supervisior_name));
$pdf->Ln(6);


$pdf->Cell(80, 5, 'Phone #');
$pdf->TextField('supervisior_phone'.$k.$k, 50, 5,array(),array('v'=>$edu->supervisior_phone, 'dv'=>$edu->supervisior_phone));
$pdf->Ln(6);
