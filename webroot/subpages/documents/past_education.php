<div id="toremove"><div class="table-scrollable">
    <table class="table table-striped">
                ...
                <tr><td>Claims with this Tutor:&nbsp;&nbsp;<input type="radio" name="claim_tutor" value="1" />&nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="claim_tutor" value="0" />&nbsp;&nbsp;&nbsp;&nbsp;No</td><td>Date Claims Occured:<input type="text" class="form-control"/></td></tr>
                ...
                <tr><td>Signature:<input type="text" class="form-control" name="signature" /></td><td>Date/Time:<input type="text" class="form-control" name="date_time" /></td></tr>
