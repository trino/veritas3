...
<div class="profile-sidebar">
    ...
    <div class="portlet light profile-sidebar-portlet">
        ...
        <div class="profile-userpic">
            <center>     <img alt="" class="img-circle" src="http://localhost/veritas3/img/uploads/male.png"> </center>       </div>
        <!-- END SIDEBAR USERPIC -->
        <!-- SIDEBAR USER TITLE -->
    ...
    <div class="portlet light">
        ...
        <div class="portlet-body">
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 305px;"><div class="scroller" style="height: 305px; overflow: hidden; width: auto;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2" data-initialized="1">
                ...
                </div><div class="slimScrollBar" style="width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 140.94696969697px; background: rgb(215, 220, 226);"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; opacity: 0.2; z-index: 90; right: 1px; background: rgb(234, 234, 234);"></div></div>
        </div>
    </div>
    <!-- END PORTLET -->
</div>
...
<li>
    ...
    <div class="task-title">
															<span class="task-title-sp">
															Document 1 testDocument 1 test</span>
...
<li>
    ...
    <div class="task-title">
															<span class="task-title-sp">
															Document 1 testDocument 1 testDocument 1 test </span>
