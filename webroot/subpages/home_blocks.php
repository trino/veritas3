                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="dashboard-stat <?php echo $class[$i]; ?>">
                        ...
                        <?php if ($this->request['controller'] != "Documents") { ?>
                            <?php if ($d->orders == 0) { ?><a class="more"
                                                              href="<?php echo $this->request->webroot; ?>documents/index?type=<?php echo urlencode($d->title); ?>">
                                    View more <i class="m-icon-swapright m-icon-white"></i>
                                </a><?php } ?>
                            <?php if ($d->orders == 1) { ?>
                                <a class="more"
                                   href="<?php echo $this->request->webroot; ?>orders/orderslist<?php if ($d->id <= 4) { ?>?table=<?php echo $d->table_name;
                                   } ?>">
                                    View more <i class="m-icon-swapright m-icon-white"></i>
                                </a>
                            <?php }
                            ...
                            ?>
                            <a class="more" id="sub_doc_click<?php echo $d->id;?>" href="javascript:;"
                               onclick="showforms('<?php echo $d->form . "?doc_id=" . $d->id;?>')">
                                Load <?php echo ucfirst($settings->document); ?><i
