<table width="100%">
        ...
        <b>Surname</b> : <span style="display: inline-block;border:1px solid #eee;padding:3px 2px;" ><?php echo $detail['consent']->last_name;?></span>
        ...
        <b>Current address</b> : <?php echo $detail['consent']->current_street_address.', '.$detail['consent']->current_apt_unit.', '.$detail['consent']->current_city.', '.$detail['consent']->current_province.', '.$detail['consent']->current_postal_code;?>
     
     
        <b>Previous address</b> : <?php echo $detail['consent']->previous_street_address.', '.$detail['consent']->previous_apt_unit.', '.$detail['consent']->previous_city.', '.$detail['consent']->previous_province.', '.$detail['consent']->previous_postal_code;?>
        ...
        <b>Current Address</b> : <?php echo $detail['consent']->criminal_current_address.', '.$detail['consent']->criminal_current_province.', '.$detail['consent']->criminal_current_postal_code;?>
     
     
     
        <!--<b>Signature of applicant</b> : <?php echo $detail['consent']->criminal_signature_applicant;?>-->
