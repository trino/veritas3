...
echo '<div id="toremove"><div class="table-scrollable">
    <table class="table table-striped">
                ...
                <tr><td>Supervisors Name:<input type="text" class="form-control"/></td><td>Phone #:<input type="text" class="form-control"/></td></tr>
                <tr><td>Supervisors Email:<input type="text" class="form-control"/></td><td>Secondary Email:<input type="text" class="form-control"/></td></tr>
