...
<script>
    ...
    $(function () {
        ...
        $('#cart_btn').click(function(){
            ...
            {
                alert('Please select driver');return false;
            }
