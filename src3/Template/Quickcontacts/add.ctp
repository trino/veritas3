                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-12">
							...
							<div class="col-md-10 nopad">
									...
									<select <?php echo $is_disabled;?> class="form-control">
                        ...
                        <div class="form-group col-md-6">
							...
							<div class="col-md-5 nopad">
								<div class="input-icon">
									...
									<input <?php echo $is_disabled;?> type="text" name="phone" class="form-control" id="phone" placeholder="Name">
								</div>
							</div>
						</div>
                       ...
                       <p>&nbsp;</p>
                        <div class="form-group col-md-6">
							...
							<div class="col-md-5 nopad">
								<div class="input-icon">
									<i class="fa fa-envelope"></i>
									<input <?php echo $is_disabled;?> type="text" name="phone" class="form-control" id="phone" placeholder="Cell number">
								</div>
							</div>
						</div>
                        ...
                        <div class="form-group col-md-6">
							...
							<div class="col-md-5 nopad">
								<select <?php echo $is_disabled;?> name="key_cellular[]" class="form-control" >
                        ...
                        <div class="form-group col-md-6">
							...
							<div class="col-md-5 nopad">
								<div class="input-icon">
									<i class="fa fa-envelope"></i>
									<input <?php echo $is_disabled;?> type="text" name="phone" class="form-control" id="phone" placeholder="Phone number">
								</div>
							</div>
						</div>
                        ...
                        <div class="form-group col-md-6">
							...
							<div class="col-md-5 nopad">
								<div class="input-icon">
									<i class="fa fa-envelope"></i>
									<input <?php echo $is_disabled;?> type="text" name="phone" class="form-control" id="phone" placeholder="Email">
								</div>
							</div>
						</div>
                        <p>&nbsp;</p>
                        <div class="form-group col-md-6">
							...
							<div class="col-md-5 nopad">
								<div class="input-icon">
									<i class="fa fa-envelope"></i>
									<input <?php echo $is_disabled;?> type="text" name="phone" class="form-control" id="phone" placeholder="Company">
								</div>
							</div>
						</div>
                        <div class="clearfix"></div>
