...
<head>
    ...
    <link href="<?php echo WEB_ROOT;?>assets/global/plugins/select2/select2.css" rel="stylesheet" type="text/css"/>
    <link href="<?php echo WEB_ROOT;?>assets/admin/pages/css/login3.css" rel="stylesheet" type="text/css"/>
    ...
    <link href="<?php echo WEB_ROOT;?>assets/admin/layout/css/themes/darkblue.css" rel="stylesheet" type="text/css" id="style_color"/>
